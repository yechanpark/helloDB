...
import java.sql.ResultSet; // incase using Anonymous Class
import java.sql.SQLException; // incase using Anonymous Class
...
import org.springframework.jdbc.core.RowMapper; // incase using Anonymous Class
...
public class OfferDAO {
	...
	public Offer getOffer(String name) {
		...
		/*
		 * use Anonymous Class return
		 * jdbcTemplateObject.queryForObject(sqlStatement, new Object[] { name
		 * }, new RowMapper<Offer>() {
		 * 
	...
	public List<Offer> getOffers() {
		...
		/*
		 * use Anonymous Class return jdbcTemplateObject.query(sqlStatement, new
		 * RowMapper<Offer>() {
		 * 
		 * public Offer mapRow(ResultSet rs, int rowNum) throws SQLException {
		 * Offer offer = new Offer();
